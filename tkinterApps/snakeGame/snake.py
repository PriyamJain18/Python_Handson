...
#Boolean value which checks if the game is running
game_over = False
while not game_over:
    ...
    #if snake hits itself, quit the game
    ...
    #If snake eats the food, increase its lenght, speed and score.
    ...
    #Places food randomly on the window
